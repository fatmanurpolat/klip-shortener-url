...
/** Klipo surface card — white, soft plum shadow, generous radius; `tone` washes it. */
export function Card({ children, tone = "default", padding = "lg", interactive = false, style, ...rest }: CardProps) {
