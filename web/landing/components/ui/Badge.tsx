...
type Tone = "neutral" | "live" | "warn" | "expired" | "info" | "rose" | "lavender";
type Size = "sm" | "md";
...
/**
 * Status badge / pill. Soft watercolor tints keyed by `tone`, with an optional
 * leading status dot.
 */
export function Badge({ children, tone = "neutral", dot = false, size = "md", style, ...rest }: BadgeProps) {
  const tones: Record<Tone, { bg: string; fg: string; dotc: string }> = {
