...
/**
 * Klipo logo — the interlocking petal-link mark, optionally with the wordmark.
 * Self-contained inline SVG so it needs no asset path.
 */
    ...
    <span style={{ display: "inline-flex", alignItems: "center", gap: Math.round(size * 0.3), ...style }} aria-label="Klipo">
      ...
      <span
        style={{
          ...
          fontWeight: "var(--fw-display-bold)" as unknown as number,
